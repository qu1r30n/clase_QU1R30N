    ...
    internal class var_fun_GG_dir_arch_crear
    {
        ...
        static public string[,] GG_ventana_emergente_productos = new string[,]
        {
            /*0*/ { "2", "ID", "" },
                ...
                /*9*/ { "4", "GRUPO", "1||1|PRODUCTO_PIEZA°PRODUCTO_CANTIDAD°PRODUCTO_ELABORADO°VENTA_INGREDIENTE|OCULTAR_CONTROL¬23¬PRODUCTO_ELABORADO°OCULTAR_CONTROL¬29¬VENTA_INGREDIENTE" },
                /*10*/ { "1", "CANT_X_PAQUET", "1|SOLO_NUMEROS" },
                /*11*/ { "1", "CODBAR_PAQUETE", "||||NO_VISIBLE°PRODUCTO_ELABORADO" },
                /*12*/ { "1", "LIGAR_PROD_SAB", "" },
                /*13*/ { "1", "IMPUESTOS", "|TODAS_MAYUSCULAS|||REYENO_TEXTBOX_VENTANA_IMPU" },
                /*14*/ { "1", "ES_ELABORADO", "||||NO_VISIBLE°VENTA_INGREDIENTE" },
                /*15*/ { "1", "CADUCIDAD", "0|SOLO_NUMEROS" },
                /*16*/ { "1", "ULTIMO_MOV", "0|SOLO_NUMEROS" },
                /*17*/ { "1", "SUCUR_VENT", "" },
                /*18*/ { "1", "CLAF_PROD", "" },
                /*19*/ { "1", "DIR_IMG_INTER", "" },
                /*20*/ { "1", "DIR_IMG_COMP", "" },
        ...
        static public string[,] GG_dir_nom_archivos =
        {
            ...
            //impuestos
            /*19*/{ GG_direccion_carpetas_base[0] + "CONFIG\\INF\\IMPUESTOS\\IMPUESTOS.TXT", columnas_concatenadas(GG_ventana_IMPUESTOS,1,var_fun_GG.GG_caracter_separacion[0]),"NOSE|0|SIN DESCRIPCION|NOSE|3"},
