    ...
    internal class var_fun_GG_dir_arch_crear
    {
        ...
        static public string[,] GG_ventana_emergente_productos = new string[,]
        {
            /*0*/ { "2", "ID", "" },
                ...
                /*11*/ { "1", "CODBAR_PAQUETE", "" },
                /*12*/ { "1", "COD_BAR_INDIVIDUAL_ES_PAQ", "" },
                /*13*/ { "1", "LIGAR_PROD_SAB", "" },
                /*14*/ { "1", "IMPUESTOS", "|TODAS_MAYUSCULAS|||REYENO_TEXTBOX_VENTANA_IMPU" },
                /*15*/ { "1", "INGREDIENTES", "||||NO_VISIBLE°PRODUCTO_ELABORADO" },
                /*16*/ { "1", "CADUCIDAD", "0|SOLO_NUMEROS" },
                /*17*/ { "1", "ULTIMO_MOV", "0|SOLO_NUMEROS" },
                /*18*/ { "1", "SUCUR_VENT", "" },
                /*19*/ { "1", "CLAF_PROD", "" },
                /*20*/ { "1", "DIR_IMG_INTER", "" },
                /*21*/ { "1", "DIR_IMG_COMP", "" },
                /*22*/ { "1", "INFO_EXTRA", "" },
                /*23*/ { "1", "PROCESO_CREAR", "||||NO_VISIBLE" },
                /*24*/ { "2", "NO_PONER_NADA", "" },
        };
        ...
        static public string[,] GG_dir_nom_archivos =
        {
            ...
            /*1*/{ GG_direccion_carpetas_base[0] + "CONFIG\\INF\\INVENTARIO\\INVENTARIO.TXT", columnas_concatenadas(GG_ventana_emergente_productos,1,var_fun_GG.GG_caracter_separacion[0]),"1|PRODUCTO|200|ML|100|COD_BAR|-7|100|PROVEDOR¬0|PRODUCTO_PIEZA|10|CODIGO_BARRAS_PAQUETE|COD_BAR_INDIVIDUAL_ES_PAQ|1|IVA||20240606|20240605|sucursal¬0°¬2024070308|BEBIDA_ALCOLICA|||§2|PRODUCTO|200|ML|100|COD_BAR1|-4|100|PROVEDOR1¬0|PRODUCTO_PIEZA|10|CODIGO_BARRAS_PAQUETE|COD_BAR_INDIVIDUAL_ES_PAQ|1|IVA||20240606|20240605|sucursal¬0°¬2024070308|BEBIDA_ALCOLICA|||"},
