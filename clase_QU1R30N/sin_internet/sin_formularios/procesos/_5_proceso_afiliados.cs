...
namespace clase_QU1R30N.sin_internet.sin_formularios.procesos
{
    internal class _5_proceso_afiliados
    {
        ...
        public void registro_simple(string id_enc_simple, string tabla_enc_simp, string datos, char caracter_separacion = '|', char caracter_separacion2 = '°', bool viene_reg_comp = false)
        {
            if (viene_reg_comp == false)
            {
                ...
                string info_movimiento = "reg_sim" + caracter_separacion + id_enc_simple + caracter_separacion + tabla_enc_simp + caracter_separacion + datos + caracter_separacion;
            ...
            int indic_afil_simp = Convert.ToInt32(bas.sacar_indice_del_arreglo_de_direccion(direccion_tab_enc_simple));
            int indic_niv_afil_simp = Convert.ToInt32(bas.sacar_indice_del_arreglo_de_direccion(direccion_tab_NIVELES_IDHORIZONTAL_enc_simple));
            ...
            {
                string[] info_base_split = Tex_base.GG_base_arreglo_de_arreglos[indic_afil_simp][i].Split(caracter_separacion);
