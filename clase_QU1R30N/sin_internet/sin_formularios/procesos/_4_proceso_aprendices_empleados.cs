...
namespace clase_QU1R30N.sin_internet.sin_formularios.procesos
{
    ...
    internal class _4_proceso_aprendices_empleados
    {
        ...
        public string registro_empleado_cod3_r_(string direccion_archivo, string datos, object caracter_separacion_obj = null)
        {
            ...
            if (res_esp_archivo_emp[0] != "0")
            {
                ...
                string Estado_de_aprendis_de_empleado = datos_espliteado[15];
                ...
                string tipo_de_aprendis_de_empleado = datos_espliteado[29];
