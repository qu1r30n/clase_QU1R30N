    ...
    internal class _8_proceso_registros
    {
        ...
        public string registrar_movimiento(string direccion_archivo, string modelo, string proceso, string datos,string fecha_o_hora, object caracter_separacion_obj = null)
        {
            ...
            if (Convert.ToInt32(res_esp_archivo[0]) > 0)
            {
                ...
                string info_agregar = fecha_o_hora + caracter_separacion_string[0] + tipo_de_operacion + caracter_separacion_string[0] + impuestos + caracter_separacion_string[0] + productos_precio_total_precio_unitario + caracter_separacion_string[0] + "SIN_COMENTARIOS" + caracter_separacion_string[0] + total_venta + caracter_separacion_string[0] + total_costo_comp + caracter_separacion_string[0] + total_pagar_imp + caracter_separacion_string[0] + "" + caracter_separacion_string[0] + ganancia_total;
                                ...
                                if (proceso == "VENTA")
                                {
                                    ...
                                    for (int i = G_donde_inicia_la_tabla; i < Tex_base.GG_base_arreglo_de_arreglos[1].Length; i++)
                                    {
                                        ...
                                        if (info_bas[5] == info_dat[0])
                                        {
                                            ...
                                            info_productos_a_concatenar = op_tex.concatenacion_caracter_separacion(info_productos_a_concatenar, info_dat[0] + caracter_separacion_string[2] + info_dat[1] + caracter_separacion_string[2] + info_bas[1], caracter_separacion_string[1]);
